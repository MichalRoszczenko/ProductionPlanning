...
namespace Production.Domain.Tests.Entities
{
    public class ProductionTests
    {
        ...
        public void ProductionTimeCalculation_ShouldSetProductionTimeInHours_ForCorrectDates(string startDate,
        ...
        public void ProductionTimeCalculation_ShouldSetProductionTimeInHours_ForNotValidDates(string startDate,
            string endDate)
        {
            //arrange 
